  ...
  // ─── 01: Leftover App Scripts ─────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        type: 'content',
        duration: 8,
        headline: 'Store Health finds them all.',
  ...
  // ─── 02: Broken Product Images ────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        type: 'content',
        duration: 8,
        headline: 'Store Health checks every image URL.',
  ...
  // ─── 03: Store Speed ──────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        ...
        body: "Store Health identifies dead scripts, oversized assets, and theme bloat — ranked by impact so you know where to start.",
        accent: true,
      },
      { type: 'cta', duration: 7 },
    ],
  ...
  // ─── 04: Missing Meta Descriptions (SEO) ─────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        ...
        body: 'Store Health audits every product, collection, and page for missing SEO fields and gives you a prioritized fix list.',
        accent: true,
      },
      { type: 'cta', duration: 7 },
    ],
  ...
  // ─── 05: Broken Discount Codes ────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        ...
        body: 'Store Health validates every active discount code and surfaces issues with usage limits, expiry dates, and conflicts.',
        accent: true,
      },
      { type: 'cta', duration: 7 },
    ],
  ...
  // ─── 06: Duplicate Variants ───────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        ...
        body: 'Store Health scans your entire product catalog for duplicate SKUs and variant combinations — with one-click navigation to fix them.',
        accent: true,
      },
      { type: 'cta', duration: 7 },
    ],
  ...
  // ─── 07: Missing Alt Texts ────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        ...
        body: "Store Health audits alt text coverage across all your products and highlights every image that's hurting your SEO.",
        accent: true,
      },
      { type: 'cta', duration: 7 },
    ],
  ...
  // ─── 08: Unused Metafields ────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        ...
        body: 'Store Health shows you every metafield definition in your store and flags the ones that nothing is actively using.',
        accent: true,
      },
      { type: 'cta', duration: 7 },
    ],
  ...
  // ─── 09: Theme Code Debt ──────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        ...
        body: 'Store Health analyzes your theme structure and flags unused sections, orphaned snippets, and risky customizations.',
        accent: true,
      },
      { type: 'cta', duration: 7 },
    ],
  ...
  // ─── 10: Pre-launch Checklist ─────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      },
      {
        ...
        body: 'Store Health finds all five — and more — in a single automated store audit.',
        accent: true,
      },
      { type: 'cta', duration: 7 },
    ],
